...
const addVote = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const post = yield posts_1.default.findOne({ _id: id, deleted: false });
        if (!post) {
        ...
        const alreadyVoted = yield votes_1.default.findOne({
            postId: id,
            email: body.email,
        });
        if (alreadyVoted) {
        ...
        yield posts_1.default.findByIdAndUpdate(id, {
            $inc: {
                votes: 1,
            },
        });
