...
export declare const votesValidationSchema: import("yup/lib/object").OptionalObjectSchema<{
    postId: import("yup/lib/string").RequiredStringSchema<string | undefined, import("yup/lib/types").AnyObject>;
